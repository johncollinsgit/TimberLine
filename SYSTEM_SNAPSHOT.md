...
- Green Shield Pest Control demo (2026-08-13): `everbranch:prepare-pest-control-demo` creates an idempotent, tenant-isolated fictional field-operations workspace with an explicitly public demo account, four fictional team members, two fictional vans, five varied service jobs, tasks, notes, shifts, a Bouncie-mapped fictional van, and separate fictional location points. `/platform/demos/green-shield-pest-control` hosts the matching 30-second self-hosted Remotion tour; its CSRF-protected demo-only POST handoff signs into the isolated fictional account and opens that workspace directly. The fixture is not production evidence and the actual Fleet Tracking page remains behind the global rollout switch and all normal policy gates.
