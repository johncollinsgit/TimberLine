...
- Modern Forestry / The Forestry Studio is tenant `1`, John's owned flagship workspace, and the live custom app this repo must protect first. Everbranch product elements are intentional inside the Modern Forestry-owned app when scoped: Rewards, Birthdays/Lifecycle, Branches, messaging, account configuration, and similar surfaces may exist without implying a broad tenant rollout.
