...
class FieldServiceJob extends Model
{
    ...
    protected $fillable = [
        ...
        'arrival_window_starts_at',
        'arrival_window_ends_at',
    ...
    protected $casts = [
        ...
        'dispatch_duration_minutes' => 'integer',
        'arrival_window_starts_at' => 'datetime',
        'arrival_window_ends_at' => 'datetime',
        'dispatch_requirements' => 'array',
        'started_at' => 'datetime',
