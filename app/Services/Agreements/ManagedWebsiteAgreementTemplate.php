...
class ManagedWebsiteAgreementTemplate
{
    ...
    public function build(
        ...
        $content = [
            ...
            'purpose' => 'Provide '.$client.' with a managed Everbranch website, a private editing workspace, customer inquiry tools, and a bespoke service relationship for turning client-supplied photographs and ideas into bounded, maintained website updates.',
            'responsibilities' => [
                $client => [
            ...
            'scope_matrix' => [
                ...
                ['thing' => 'Platform maintenance and improvements', 'surface' => 'Everbranch', 'approach' => 'Hosting maintenance, security and compatibility updates, and eligible improvements to standard Everbranch website and AI-assisted features released generally to the same service plan while the subscription remains active.'],
            ...
            'scope_sections' => [
                ...
                ['title' => 'What the monthly service includes', 'body' => 'While the subscription is active and in good standing, the monthly fee includes the managed editor, hosting at one Everbranch address, draft and mobile previews, version history and rollback, the tenant-owned leads inbox, access for up to three named client users, hosting maintenance, security and compatibility updates, eligible standard platform improvements, up to ten client-supplied photograph or catalog-content additions or replacements per calendar month, and up to two consolidated content-update requests per calendar month with one reasonable revision round per request. Unused monthly allowances do not roll over.'],
                ['title' => 'Why the service has a setup fee and a monthly price', 'body' => 'This is a managed, bespoke website service rather than a one-time template download. The one-time fee covers the tenant workspace, initial design configuration, launch-page foundation, verified business details, and quote-flow setup. The monthly price covers continued licensed use of Everbranch, hosting and platform upkeep, the stated hands-on content allowance, and eligible improvements to the standard service. It gives '.$client.' a direct path to send photographs and ideas for implementation without maintaining website infrastructure or assembling separate plugins and contractors for routine included changes.'],
                ['title' => 'Everbranch and AI-assisted improvements', 'body' => 'Everbranch is an evolving software platform. As its standard website tools and AI-assisted capabilities improve, '.$client.' will receive eligible enhancements released generally to the same service plan, subject to availability, safety, compatibility, law, and third-party terms. This does not promise a particular future feature, release date, business result, unlimited AI usage, a separately priced module, or client-specific programming beyond the stated monthly limits.'],
        ...
        $pricing = [
            ...
            'cards' => [
                ['key' => 'everbranch_onboarding', 'cost_category' => 'everbranch_service', 'label' => 'Managed website launch foundation', 'amount_cents' => $onboardingAmountCents, 'frequency' => 'one_time', 'owner' => 'Everbranch', 'collectible_by_everbranch' => true, 'payment_timing' => 'due_on_acceptance', 'detail' => 'One-time bespoke workspace and private-draft setup, supported starter design, up to six standard pages, verified contact details, and one quote-only offering.'],
                ['key' => 'everbranch_launch_partner', 'cost_category' => 'everbranch_service', 'label' => 'Founder Launch Partner managed website service', 'amount_cents' => $launchPartnerAmountCents, 'frequency' => 'month', 'owner' => 'Everbranch', 'collectible_by_everbranch' => true, 'payment_timing' => 'recurring_current', 'detail' => 'First six consecutive billing cycles with licensed platform access, hosting and upkeep, eligible standard improvements, and the hands-on monthly service limits stated in scope.'],
                ['key' => 'everbranch_standard', 'cost_category' => 'everbranch_service', 'label' => 'Standard managed website service', 'amount_cents' => $standardAmountCents, 'frequency' => 'month', 'owner' => 'Everbranch', 'collectible_by_everbranch' => true, 'payment_timing' => 'recurring_future', 'detail' => 'Begins with billing cycle seven and continues month to month with the same platform access, eligible standard improvements, and stated service limits until changed by a later accepted agreement.'],
