    ...
    public function build(
        ...
        $pricing = [
            ...
            'cards' => [
                ...
                ['key' => 'approved_third_party_services', 'cost_category' => 'third_party', 'label' => 'Approved provider costs', 'amount_cents' => null, 'display_amount' => 'Provider-priced', 'frequency' => 'as_charged', 'owner' => 'Third-party providers', 'collectible_by_everbranch' => false, 'detail' => 'QuickBooks subscription, SMS usage/carrier fees, Stripe processing, taxes, and other approved services are billed under their applicable terms.'],
