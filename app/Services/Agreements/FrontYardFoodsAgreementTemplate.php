    ...
    public function build(?int $implementationAmountCents = null, ?int $dueOnAcceptanceCents = null, ?int $dueBeforeLaunchCents = null, ?string $additionalScope = null): array
    {
        ...
        $termination = [
            ...
            'terms' => [
                ...
                'Evergrove will not sell Front Yard Foods data or share it with unrelated third parties, and will use provider access only for approved service delivery, support, reporting, security, legal compliance, and client-authorized integrations.',
