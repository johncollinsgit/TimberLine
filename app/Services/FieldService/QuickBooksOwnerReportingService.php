        ...
        return [
            ...
            'cards' => [
                ...
                'employee_labor' => [
                    ...
                    'prior_including_owner' => $priorFinancials['wages'],
                    'prior_excluding_owner' => $priorFinancials['wages_excluding_owner'],
                    'prior_including_owner_percent' => $this->percent($priorFinancials['wages'], $priorFinancials['income']),
                    'prior_excluding_owner_percent' => $this->percent($priorFinancials['wages_excluding_owner'], $priorFinancials['income']),
                ...
                'contract_labor' => [
                    ...
                    'prior_amount' => $priorFinancials['contract_labor'],
                    'prior_percent' => $this->percent($priorFinancials['contract_labor'], $priorFinancials['income']),
                ],
                'combined_labor' => [
                    ...
                    'prior_amount' => $this->nullableSum($priorFinancials['wages'], $priorFinancials['contract_labor']),
                    'prior_percent' => $this->percent($this->nullableSum($priorFinancials['wages'], $priorFinancials['contract_labor']), $priorFinancials['income']),
                ],
                'work_billed' => [
