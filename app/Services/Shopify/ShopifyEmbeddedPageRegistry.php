...
class ShopifyEmbeddedPageRegistry
{
    ...
    public function pages(): array
    {
        return [
            ...
            [
                'key' => 'home.replacements',
                'route_name' => 'shopify.app.replacements',
                ...
                'module_key' => 'integrations',
                'searchable' => true,
                'search_badge' => 'Cutover',
                'search_subtitle' => 'Reconcile imports, review evidence, and stage isolated provider cutovers.',
                'search_keywords' => ['replacements', 'cutover', 'migration', 'readiness', 'apps'],
                'prefetch_priority' => 'normal',
            ],
            [
                'key' => 'subscriptions',
