...
class ShopifyEmbeddedPageRegistry
{
    ...
    public function pages(): array
    {
        return [
            ...
            [
                'key' => 'subscriptions',
                'route_name' => 'shopify.app.subscriptions',
                'label' => 'Subscriptions',
                'section' => 'subscriptions',
                'group' => 'primary',
                'icon_key' => 'arrow-path-rounded-square',
                'module_key' => 'subscriptions',
                'required_capability' => 'subscriptions.manage',
                'requires_enabled_access' => true,
                'preview_when_locked' => true,
                'searchable' => true,
                'search_badge' => 'Subscriptions',
                'search_subtitle' => 'Recharge migration, Shopify subscription operations, Candle Club rules, and voting.',
                'search_keywords' => ['subscriptions', 'recharge', 'candle club', 'recurring', 'billing', 'polls', 'voting'],
                'prefetch_priority' => 'high',
            ],
            [
                'key' => 'product_options',
                ...
                'required_capability' => 'shopify.product_options',
                'requires_enabled_access' => true,
                'searchable' => true,
                'search_badge' => 'Shopify only',
                'search_subtitle' => 'Assign scent rulesets and bundle selection counts to Shopify products.',
                'search_keywords' => ['product options', 'scents', 'bundles', 'infinite options', 'shopify'],
                'prefetch_priority' => 'high',
            ],
            [
                'key' => 'assistant',
                'route_name' => 'shopify.app.assistant.start',
                'label' => 'AI Assistant',
                'section' => 'assistant',
                'group' => 'primary',
                'icon_key' => 'sparkles',
                'module_key' => 'ai',
                'required_capability' => 'ai.assistant',
                'requires_enabled_access' => true,
                'preview_when_locked' => true,
                'searchable' => true,
                'search_badge' => 'Assistant',
                'search_subtitle' => 'Tenant-aware AI workspace for guided opportunities and human-reviewed campaign drafts.',
                'search_keywords' => ['ai assistant', 'assistant', 'opportunities', 'draft campaigns', 'setup', 'activity'],
                'prefetch_priority' => 'high',
            ],
            [
                'key' => 'assistant.start',
                ...
                'label' => 'Start Here',
                'section' => 'assistant',
                'group' => 'assistant_subnav',
                'icon_key' => 'sparkles',
                'module_key' => 'ai',
                'required_capability' => 'ai.start_here',
                'requires_enabled_access' => true,
                'searchable' => true,
                'search_badge' => 'Assistant',
                'search_subtitle' => 'Start with tenant-aware AI readiness and next-step guidance.',
                'search_keywords' => ['assistant start', 'start here', 'ai setup'],
                'prefetch_priority' => 'normal',
            ],
            [
                'key' => 'assistant.opportunities',
                'route_name' => 'shopify.app.assistant.opportunities',
                'label' => 'Top Opportunities',
                'section' => 'assistant',
                'group' => 'assistant_subnav',
                'icon_key' => 'chart-bar',
                'module_key' => 'ai',
                'required_capability' => 'ai.opportunities',
                'requires_enabled_access' => true,
                'searchable' => true,
                'search_badge' => 'Assistant',
                'search_subtitle' => 'Review high-impact opportunities before drafting campaigns.',
                'search_keywords' => ['top opportunities', 'opportunities', 'assistant opportunities'],
                'prefetch_priority' => 'normal',
            ],
            [
                'key' => 'assistant.drafts',
                'route_name' => 'shopify.app.assistant.drafts',
                'label' => 'Draft Campaigns',
                'section' => 'assistant',
                'group' => 'assistant_subnav',
                'icon_key' => 'document-text',
                'module_key' => 'ai',
                'required_capability' => 'ai.draft_campaigns',
                'requires_enabled_access' => true,
                'searchable' => true,
                'search_badge' => 'Assistant',
                'search_subtitle' => 'Prepare campaign drafts that require human review before sending.',
                'search_keywords' => ['draft campaigns', 'campaign drafts', 'assistant drafts'],
                'prefetch_priority' => 'normal',
            ],
            [
                'key' => 'assistant.setup',
                'route_name' => 'shopify.app.assistant.setup',
                'label' => 'Setup',
                'section' => 'assistant',
                'group' => 'assistant_subnav',
                'icon_key' => 'wrench-screwdriver',
                'module_key' => 'ai',
                'required_capability' => 'ai.setup',
                'requires_enabled_access' => true,
                'searchable' => true,
                'search_badge' => 'Assistant',
                'search_subtitle' => 'Track prerequisite setup states needed for AI-assisted workflows.',
                'search_keywords' => ['assistant setup', 'setup'],
                'prefetch_priority' => 'normal',
            ],
            [
                'key' => 'assistant.activity',
                'route_name' => 'shopify.app.assistant.activity',
                'label' => 'Activity',
                'section' => 'assistant',
                'group' => 'assistant_subnav',
                'icon_key' => 'clock',
                'module_key' => 'ai',
                'required_capability' => 'ai.activity',
                'requires_enabled_access' => true,
                'searchable' => true,
                'search_badge' => 'Assistant',
                'search_subtitle' => 'Review recent AI-relevant workspace signals and outcomes.',
                'search_keywords' => ['assistant activity', 'activity'],
                'prefetch_priority' => 'normal',
            ],
            [
                'key' => 'customers',
            ...
            [
                'key' => 'messaging.setup',
                'route_name' => 'shopify.app.messaging.setup',
                'label' => 'Setup',
                'section' => 'messaging',
                ...
                'searchable' => true,
                'search_badge' => 'Messaging',
                'search_subtitle' => 'Check messaging readiness, storefront tracking status, and setup actions.',
                'search_keywords' => [
                    'messaging setup',
                    'setup',
                    'module state',
            ...
            [
                'key' => 'messaging.analytics',
                'route_name' => 'shopify.app.messaging.analytics',
                ...
                'searchable' => true,
                'search_badge' => 'Messaging',
                'search_subtitle' => 'Measure opens, link clicks, and attributed orders from message sends.',
                'search_keywords' => [
                    'message analytics',
                    'campaign analytics',
                    'message clicks',
            ...
            [
                'key' => 'messaging.app_messages',
                'route_name' => 'shopify.app.messaging.app-messages',
                'label' => 'App Messages',
                'section' => 'messaging',
                'group' => 'messaging_subnav',
                'icon_key' => 'device-phone-mobile',
                'module_key' => 'messaging',
                'requires_enabled_access' => true,
                'searchable' => true,
                'search_badge' => 'Messaging',
                'search_subtitle' => 'Review two-way support threads coming from the Modern Forestry mobile app.',
                'search_keywords' => [
                    'app messages',
                    'mobile support',
                    'modern forestry app',
            ...
            [
                ...
                'module_key' => 'settings',
                'searchable' => true,
                'search_badge' => 'App Content',
                'search_subtitle' => 'Edit customer dashboard and native mobile app content.',
                'search_keywords' => ['edit app', 'app content', 'mobile home', 'customer dashboard', 'hero slides'],
                'prefetch_priority' => 'normal',
            ],
            [
                'key' => 'settings',
