...
class MarketingShopifyIntegrationController extends Controller
{
    ...
    public function logFunnelEvent(
        ...
        $data = $request->validate([
            ...
            'mf_channel' => ['nullable', 'string', 'max:80'],
            'mf_source_label' => ['nullable', 'string', 'max:180'],
            'mf_template_key' => ['nullable', 'string', 'max:180'],
            'mf_campaign_id' => ['nullable', 'string', 'max:80'],
            'mf_delivery_id' => ['nullable', 'string', 'max:80'],
            'mf_profile_id' => ['nullable', 'string', 'max:80'],
            'mf_campaign_recipient_id' => ['nullable', 'string', 'max:80'],
            'mf_module_type' => ['nullable', 'string', 'max:80'],
            'mf_module_position' => ['nullable', 'string', 'max:80'],
            'mf_product_id' => ['nullable', 'string', 'max:180'],
            'mf_tile_position' => ['nullable', 'string', 'max:80'],
            'mf_link_label' => ['nullable', 'string', 'max:180'],
