    ...
    protected function resourceDefinitions(): array
    {
        return [
            ...
            'wholesale-custom-scents' => [
                ...
                'search' => ['account_name', 'custom_scent_name', 'oil_1', 'oil_2', 'oil_3', 'abbreviation', 'notes'],
                ...
                'fields' => [
                    ...
                    ['key' => 'oil_1', 'label' => 'Oil #1', 'type' => 'text', 'default' => '', 'nullable' => true, 'rules' => ['nullable', 'string', 'max:255']],
                    ['key' => 'oil_2', 'label' => 'Oil #2', 'type' => 'text', 'default' => '', 'nullable' => true, 'rules' => ['nullable', 'string', 'max:255']],
                    ['key' => 'oil_3', 'label' => 'Oil #3', 'type' => 'text', 'default' => '', 'nullable' => true, 'rules' => ['nullable', 'string', 'max:255']],
                    ['key' => 'total_oils', 'label' => 'Total Oils', 'type' => 'number', 'default' => null, 'nullable' => true, 'rules' => ['nullable', 'integer', 'min:0']],
                    ['key' => 'abbreviation', 'label' => 'Abbrev', 'type' => 'text', 'default' => '', 'nullable' => true, 'rules' => ['nullable', 'string', 'max:50']],
