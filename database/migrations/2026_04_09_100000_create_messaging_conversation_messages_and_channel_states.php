...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('messaging_conversation_messages') && ! Schema::hasTable('messaging_contact_channel_states')) {
            Schema::drop('messaging_conversation_messages');
        }

        if (! Schema::hasTable('messaging_conversation_messages')) {
        ...
        if (! Schema::hasTable('messaging_contact_channel_states')) {
