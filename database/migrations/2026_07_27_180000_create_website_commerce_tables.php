...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('website_customer_addresses', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('tenant_id')->constrained()->cascadeOnDelete();
            $table->foreignId('website_customer_id')->constrained('website_customers')->cascadeOnDelete();
        ...
        Schema::create('website_product_variants', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('tenant_id')->constrained()->cascadeOnDelete();
            $table->foreignId('website_product_id')->constrained('website_products')->cascadeOnDelete();
        ...
        Schema::create('website_inventory_movements', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('tenant_id')->constrained()->cascadeOnDelete();
            $table->foreignId('website_product_variant_id')->constrained('website_product_variants')->cascadeOnDelete();
        ...
        Schema::create('website_carts', function (Blueprint $table): void {
            ...
            $table->string('status', 24)->default('active')->index();
            $table->foreignId('website_customer_id')->nullable()->constrained('website_customers')->nullOnDelete();
            $table->timestamps();
        ...
        Schema::create('website_order_lines', function (Blueprint $table): void {
            ...
            $table->foreignId('website_product_variant_id')->nullable()->constrained('website_product_variants')->nullOnDelete();
            $table->string('title', 190);
