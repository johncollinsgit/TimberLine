...
CREATE TABLE `modern_forestry_fundraiser_invoice_packages` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `package_reference` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'review_required',
  `delivery_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_sent',
  `tracking_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_available',
  `payer_name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `prepared_by` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `modern_forestry_fundraiser_orders` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `source` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'zapier',
  `external_order_id` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_reference` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recipient_name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `recipient_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recipient_phone` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tax_cents` int unsigned NOT NULL DEFAULT '0',
  `total_cents` int unsigned NOT NULL,
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'needs_review',
  ...
  `received_at` timestamp NOT NULL,
  `reviewed_at` timestamp NULL DEFAULT NULL,
  `reviewed_by` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
