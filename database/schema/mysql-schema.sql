...
CREATE TABLE `accounting_close_items` (
  ...
  `definition_key` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sort_order` smallint unsigned NOT NULL DEFAULT '0',
  `status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
  `deep_link` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `owner_notes` text COLLATE utf8mb4_unicode_ci,
  `evidence` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `accounting_compliance_tasks` (
  ...
  `period_key` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'setup',
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `explanation` text COLLATE utf8mb4_unicode_ci,
  `jurisdiction` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `obligation` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `due_at` timestamp NULL DEFAULT NULL,
  `amount_due` decimal(14,2) DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'needs_setup',
  `destination_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `destination_url` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_url` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quickbooks_expected` tinyint(1) NOT NULL DEFAULT '0',
  `confidence` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unverified',
  `assignee_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `accounting_debt_snapshots` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `source_account_id` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `source_metadata` longtext COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `accounting_event_source_imports` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `source_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'spreadsheet',
  ...
  `mapping_version` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mapping_required',
  `source_metadata` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `accounting_profiles` (
  ...
  `country_code` char(2) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'US',
  `state_code` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tax_year_basis` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'calendar',
  `accounting_basis` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'accrual',
  `setup_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'needs_review',
...
CREATE TABLE `accounting_revenue_rules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `stream_key` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_system` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `matcher_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `matcher_fingerprint` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `matcher_value` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `agentic_changes` (
  ...
  `category` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'shipped',
...
CREATE TABLE `agreement_acceptances` (
  ...
  `signer_legal_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `signer_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `signer_email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `electronic_signature_value` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `electronic_signature_type` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'typed',
  ...
  `snapshot_hash` char(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `agreement_terminations` (
  ...
  `export_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_requested',
  `export_reference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `agreement_versions` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rendered_content` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `agreements` (
  ...
  `agreement_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `public_token_hash` char(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `public_token_encrypted` text COLLATE utf8mb4_unicode_ci,
  ...
  `agreement_sms_message` text COLLATE utf8mb4_unicode_ci,
  `agreement_mms_image_url` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `automation_workflow_action_receipts` (
  ...
  `status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'dispatching',
...
CREATE TABLE `automation_workflow_domain_events` (
  ...
  `subject_type` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `automation_workflow_links` (
  ...
  `automation_workflow_id` bigint unsigned DEFAULT NULL,
  `step_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'action',
  `workflow_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_system` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `destination_system` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `destination_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_fingerprint` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metadata` json DEFAULT NULL,
...
CREATE TABLE `automation_workflow_run_items` (
  ...
  `automation_workflow_version_id` bigint unsigned NOT NULL,
  `trigger_step_id` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `payload` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `context` longtext COLLATE utf8mb4_unicode_ci,
  `execution_stack` longtext COLLATE utf8mb4_unicode_ci,
  `current_step_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `automation_workflow_run_steps` (
  ...
  `parent_step_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `branch_key` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `automation_workflow_runs` (
  ...
  `mode` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'scheduled',
...
CREATE TABLE `automation_workflow_versions` (
  ...
  `definition_hash` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `birthday_message_events` (
  ...
  `event_key` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `campaign_type` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `birthday_reward_issuances` (
  ...
  `reward_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reward_name` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'issued',
  `points_awarded` int DEFAULT NULL,
  `candle_cash_awarded` int DEFAULT NULL,
  `reward_value` decimal(10,2) DEFAULT NULL,
  `reward_code` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_discount_id` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_store_key` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_discount_node_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `discount_sync_status` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `discount_sync_error` text COLLATE utf8mb4_unicode_ci,
  ...
  `order_number` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_total` decimal(10,2) DEFAULT NULL,
  `attributed_revenue` decimal(10,2) DEFAULT NULL,
  `campaign_type` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `blend_components` (
  ...
  `component_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'oil',
...
CREATE TABLE `blends` (
  ...
  `lifecycle_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
...
CREATE TABLE `candle_cash_redemptions` (
  ...
  `redeemed_channel` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_order_source` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_order_id` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `redemption_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'issued',
  `issued_at` timestamp NULL DEFAULT NULL,
  `expires_at` timestamp NULL DEFAULT NULL,
  `redeemed_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `candle_cash_referrals` (
  ...
  `referred_identity_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `referred_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `referred_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'captured',
  `qualifying_order_source` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `qualifying_order_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `qualifying_order_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `referrer_reward_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `referred_reward_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `first_seen_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `candle_cash_task_completions` (
  ...
  `completion_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `request_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `proof_text` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `candle_cash_task_events` (
  ...
  `verification_mode` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_event_key` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `candle_cash_tasks` (
  ...
  `verification_mode` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual_review_fallback',
  `auto_award` tinyint(1) NOT NULL DEFAULT '0',
  `campaign_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_object_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `eligibility_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'everyone',
  `required_customer_tags` json DEFAULT NULL,
  `required_membership_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `visible_to_noneligible_customers` tinyint(1) NOT NULL DEFAULT '0',
  `locked_message` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `locked_cta_text` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `locked_cta_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `candle_cash_transactions` (
  ...
  `source_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `gift_intent` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gift_origin` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notified_via` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `catalog_item_costs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `shopify_store_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_product_id` bigint unsigned DEFAULT NULL,
  `shopify_variant_id` bigint unsigned DEFAULT NULL,
  `sku` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `scent_id` bigint unsigned DEFAULT NULL,
  `size_id` bigint unsigned DEFAULT NULL,
  `cost_amount` decimal(10,2) NOT NULL,
  `currency_code` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `effective_at` timestamp NULL DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `class_enrollments` (
  ...
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'confirmed',
  `email_reminders_enabled` tinyint(1) NOT NULL DEFAULT '1',
  `sms_reminders_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `source` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'public_signup',
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `class_scheduling_settings` (
  ...
  `timezone` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'America/New_York',
  `public_heading` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Upcoming classes',
  `public_intro` text COLLATE utf8mb4_unicode_ci,
  ...
  `brand_color` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#42654a',
...
CREATE TABLE `client_project_milestones` (
  ...
  `status` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'upcoming',
...
CREATE TABLE `client_project_phases` (
  ...
  `summary` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_started',
  `starts_on` date DEFAULT NULL,
  `due_on` date DEFAULT NULL,
  `completed_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `client_project_ticket_references` (
  ...
  `reference_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'link',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `sort_order` int unsigned NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `client_project_ticket_tasks` (
  ...
  `owner_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'evergrove',
...
CREATE TABLE `client_project_ticket_votes` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `client_project_ticket_id` bigint unsigned NOT NULL,
  `voter_hash` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `client_project_tickets` (
  ...
  `requested_by_user_id` bigint unsigned DEFAULT NULL,
  `reviewed_by_user_id` bigint unsigned DEFAULT NULL,
  `type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'feature',
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_summary` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `desired_outcome` text COLLATE utf8mb4_unicode_ci,
  `scope_notes` text COLLATE utf8mb4_unicode_ci,
  `urgency` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
  `priority` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
  `status` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'new',
  `customer_visible` tinyint(1) NOT NULL DEFAULT '1',
  `landlord_notes` text COLLATE utf8mb4_unicode_ci,
  `reviewed_at` timestamp NULL DEFAULT NULL,
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `client_project_updates` (
  ...
  `visibility` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'client',
  `published_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `client_projects` (
  ...
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `summary` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'planning',
  `health` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'on_track',
  `starts_on` date DEFAULT NULL,
  `due_on` date DEFAULT NULL,
  `completed_at` timestamp NULL DEFAULT NULL,
  `sort_order` int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `commerce_external_records` (
  ...
  `external_id` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `external_parent_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `commerce_import_events` (
  ...
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'recorded',
...
CREATE TABLE `commerce_import_runs` (
  ...
  `commerce_source_id` bigint unsigned NOT NULL,
  `initiated_by_user_id` bigint unsigned DEFAULT NULL,
  `mode` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'dry_run',
...
CREATE TABLE `commerce_sources` (
  ...
  `external_account_label` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mode` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'connected_operations',
...
CREATE TABLE `custom_module_requests` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `requested_by_user_id` bigint unsigned DEFAULT NULL,
  `related_module_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `problem_summary` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `current_workaround` text COLLATE utf8mb4_unicode_ci,
  `desired_outcome` text COLLATE utf8mb4_unicode_ci,
  `tools_involved` text COLLATE utf8mb4_unicode_ci,
  `users_impacted` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `mobile_relevance` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `customer_access_requests` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `intent` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'production',
  `application_kind` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform_access',
  ...
  `requested_tenant_slug` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message` text COLLATE utf8mb4_unicode_ci,
  `metadata` json DEFAULT NULL,
  ...
  `activation_email_last_attempt_status` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `customer_birthday_profiles` (
  ...
  `source` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signup_source` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `customer_equipment` (
  ...
  `equipment_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'generator',
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `customer_external_profiles` (
  ...
  `integration` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_customer_id` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `external_customer_gid` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `vip_tier` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `referral_link` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `customer_loop_actions` (
  ...
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'suggested',
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `customer_loop_activities` (
  ...
  `event_key` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `summary` text COLLATE utf8mb4_unicode_ci,
  `safe_context` json DEFAULT NULL,
  `occurred_at` timestamp NOT NULL,
...
CREATE TABLE `customer_merge_operation_members` (
  ...
  `marketing_profile_id` bigint unsigned NOT NULL,
  `shopify_customer_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `role` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'donor',
  `outcome` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `snapshot` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `customer_merge_operations` (
  ...
  `store_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `source` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'everbranch_wizard',
  `idempotency_key` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `survivor_profile_id` bigint unsigned DEFAULT NULL,
  `shopify_kept_customer_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_deleted_customer_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_job_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `initiated_by` bigint unsigned DEFAULT NULL,
  `approved_by` bigint unsigned DEFAULT NULL,
  `shopify_admin_user_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `development_change_logs` (
  ...
  `created_by` bigint unsigned DEFAULT NULL,
  `shopify_admin_user_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_admin_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `event_box_plans` (
  ...
  `scent_raw` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `event_instances` (
  ...
  `primary_runner` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `event_shipments` (
  ...
  `scent_id` bigint unsigned DEFAULT NULL,
  `size_id` bigint unsigned DEFAULT NULL,
  `wick_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `events` (
  ...
  `parse_confidence` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `everbranch_mobile_push_devices` (
  ...
  `device_token_hash` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `app_version` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `device_name` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `field_service_estimates` (
  ...
  `field_service_job_id` bigint unsigned DEFAULT NULL,
  `created_by_user_id` bigint unsigned DEFAULT NULL,
  `estimate_number` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
...
CREATE TABLE `field_service_financial_document_attachments` (
  ...
  `external_id` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_type` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `field_service_financial_document_lines` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `field_service_financial_document_id` bigint unsigned NOT NULL,
  `source_line_id` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sort_order` int unsigned NOT NULL DEFAULT '0',
  `detail_type` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `item_external_id` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `field_service_financial_documents` (
  ...
  `marketing_profile_id` bigint unsigned DEFAULT NULL,
  `field_service_job_id` bigint unsigned DEFAULT NULL,
  `source` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'quickbooks',
...
CREATE TABLE `field_service_job_notes` (
  ...
  `created_by_user_id` bigint unsigned DEFAULT NULL,
  `body` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status_update` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `field_service_job_notifications` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `channel` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `event_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'comment',
...
CREATE TABLE `field_service_job_participants` (
  ...
  `field_service_job_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned NOT NULL,
  `role` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'member',
...
CREATE TABLE `field_service_jobs` (
  ...
  `operational_status` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status_source` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'system',
  `priority` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
  `customer_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `project_manager_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `project_manager_company` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `project_manager_phone` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `project_manager_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lock_box_code` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_address_line_1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_address_line_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_city` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_state` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_postal_code` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_country` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `scheduled_for` timestamp NULL DEFAULT NULL,
  `scheduled_end_at` timestamp NULL DEFAULT NULL,
  `started_at` timestamp NULL DEFAULT NULL,
  `blocked_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `completed_at` timestamp NULL DEFAULT NULL,
  `canceled_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `field_service_materials` (
  ...
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'needed',
  `external_source` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_id` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `field_service_price_book_candidates` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `source` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'quickbooks',
  `normalized_key` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'suggested',
...
CREATE TABLE `field_service_price_book_items` (
  ...
  `external_id` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item_type` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sku` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `unit_price` decimal(14,4) DEFAULT NULL,
...
CREATE TABLE `field_service_reminder_settings` (
  ...
  `cadence` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'daily',
  `send_time` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `timezone` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'America/New_York',
  `provider_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_verified',
  `customer_copy` text COLLATE utf8mb4_unicode_ci,
  `internal_notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `field_service_work_candidates` (
  ...
  `customer_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_phone` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` decimal(14,2) DEFAULT NULL,
  `balance` decimal(14,2) DEFAULT NULL,
  `description` longtext COLLATE utf8mb4_unicode_ci,
  `service_address_line_1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_address_line_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_city` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_state` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_postal_code` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_country` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `priority` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
...
CREATE TABLE `form_submissions` (
  ...
  `submitted_at` timestamp NULL DEFAULT NULL,
  `submitter_name` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `submitter_email` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `submitter_phone` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `submitter_company` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payload` json DEFAULT NULL,
...
CREATE TABLE `form_templates` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `visibility` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'internal',
  `handler_key` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `google_business_profile_connections` (
  ...
  `connection_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'disconnected',
  `connected_by_user_id` bigint unsigned DEFAULT NULL,
  `google_subject` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_account_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `access_token` text COLLATE utf8mb4_unicode_ci,
  `refresh_token` text COLLATE utf8mb4_unicode_ci,
  `token_type` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `expires_at` timestamp NULL DEFAULT NULL,
  `granted_scopes` json DEFAULT NULL,
  `linked_account_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linked_account_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linked_account_display_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linked_location_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linked_location_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linked_location_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linked_location_place_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linked_location_maps_uri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `project_approval_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unknown',
...
CREATE TABLE `google_business_profile_locations` (
  ...
  `account_display_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `website_uri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `place_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `maps_uri` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `google_business_profile_reviews` (
  ...
  `external_review_id` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `reviewer_profile_photo_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reviewer_is_anonymous` tinyint(1) NOT NULL DEFAULT '0',
  `comment` text COLLATE utf8mb4_unicode_ci,
  `review_reply_comment` text COLLATE utf8mb4_unicode_ci,
  `created_time` timestamp NULL DEFAULT NULL,
  `updated_time` timestamp NULL DEFAULT NULL,
  `sync_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'synced',
...
CREATE TABLE `google_business_profile_sync_runs` (
  ...
  `trigger_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'running',
...
CREATE TABLE `import_normalizations` (
  ...
  `normalized_value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `integration_connections` (
  ...
  `external_account_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `external_account_secret` text COLLATE utf8mb4_unicode_ci,
  `external_account_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `access_token` text COLLATE utf8mb4_unicode_ci,
  `refresh_token` text COLLATE utf8mb4_unicode_ci,
  `token_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `oauth_client_id` text COLLATE utf8mb4_unicode_ci,
  `oauth_client_secret` text COLLATE utf8mb4_unicode_ci,
  `expires_at` timestamp NULL DEFAULT NULL,
  ...
  `connected_at` timestamp NULL DEFAULT NULL,
  `last_synced_at` timestamp NULL DEFAULT NULL,
  `last_error_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_error_message` text COLLATE utf8mb4_unicode_ci,
  `last_error_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `landlord_catalog_entries` (
  ...
  `recurring_interval` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'month',
...
CREATE TABLE `landlord_operator_actions` (
  ...
  `target_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `context` json DEFAULT NULL,
...
CREATE TABLE `landlord_prospect_communications` (
  ...
  `direction` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'note',
  `channel` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'email',
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'logged',
...
CREATE TABLE `landlord_prospect_discovery_runs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `provider` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'google_places',
  `trade` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `search_region` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `search_query` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `website_preference` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'missing_only',
  `status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `landlord_prospects` (
  ...
  `website_status` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fit_score` tinyint unsigned DEFAULT NULL,
  `opportunity_priority` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_rating` decimal(3,2) DEFAULT NULL,
  `google_review_count` int unsigned DEFAULT NULL,
  `discovery_query` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_snapshot` json DEFAULT NULL,
  `last_verified_at` timestamp NULL DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'new',
  `source` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `mapping_exceptions` (
  ...
  `shopify_order_id` bigint unsigned DEFAULT NULL,
  `account_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `raw_scent_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `raw_variant` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sku` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payload_json` json DEFAULT NULL,
  `resolved_at` timestamp NULL DEFAULT NULL,
  `excluded_at` timestamp NULL DEFAULT NULL,
  `excluded_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `excluded_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `market_plans` (
  ...
  `box_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `marketing_automation_events` (
  ...
  `tenant_id` bigint unsigned DEFAULT NULL,
  `marketing_profile_id` bigint unsigned DEFAULT NULL,
  `trigger_key` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `channel` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'queued_intent',
  `store_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reason` text COLLATE utf8mb4_unicode_ci,
  `context` json DEFAULT NULL,
  `occurred_at` timestamp NOT NULL,
...
CREATE TABLE `marketing_campaign_conversions` (
  ...
  `attribution_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_campaign_recipients` (
  ...
  `rejected_by` bigint unsigned DEFAULT NULL,
  `rejected_at` timestamp NULL DEFAULT NULL,
  `last_status_note` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `marketing_campaigns` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci,
  `message_subject` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message_body` text COLLATE utf8mb4_unicode_ci,
  `message_html` longtext COLLATE utf8mb4_unicode_ci,
  `target_snapshot` json DEFAULT NULL,
  `status_counts` json DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `channel` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sms',
  `source_label` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_consent_requests` (
  ...
  `source_id` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payload` json DEFAULT NULL,
...
CREATE TABLE `marketing_delivery_events` (
  ...
  `event_hash` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payload` json DEFAULT NULL,
  `occurred_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `marketing_email_deliveries` (
  ...
  `tenant_id` bigint unsigned DEFAULT NULL,
  `store_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `batch_id` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_label` varchar(140) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message_subject` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_message_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `campaign_type` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `template_key` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_event_source_mappings` (
  ...
  `tenant_id` bigint unsigned DEFAULT NULL,
  `source_system` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `raw_value` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `normalized_value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_group_import_rows` (
  ...
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `external_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `marketing_profile_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `marketing_identity_reviews` (
  ...
  `raw_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `raw_first_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `raw_last_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `marketing_message_deliveries` (
  ...
  `rendered_message` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `send_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'queued',
...
CREATE TABLE `marketing_message_engagement_events` (
  ...
  `provider` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_event_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_message_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `link_label` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `url` text COLLATE utf8mb4_unicode_ci,
  `normalized_url` text COLLATE utf8mb4_unicode_ci,
  `url_domain` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_message_group_members` (
  ...
  `marketing_profile_id` bigint unsigned DEFAULT NULL,
  `source_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'profile',
  `full_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_message_groups` (
  ...
  `system_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `created_by` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `marketing_message_jobs` (
  ...
  `store_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `channel` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `job_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'send',
...
CREATE TABLE `marketing_message_media_assets` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `store_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `channel` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'email',
  `disk` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'public',
...
CREATE TABLE `marketing_message_order_attributions` (
  ...
  `source_module_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_campaign_id` bigint unsigned DEFAULT NULL,
  `source_campaign_label` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `attribution_model` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'last_click',
  `attribution_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'direct',
  `confidence_percent` tinyint unsigned NOT NULL DEFAULT '100',
  `attribution_window_days` smallint unsigned NOT NULL DEFAULT '7',
  `attributed_url` text COLLATE utf8mb4_unicode_ci,
  `normalized_url` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `marketing_order_event_attributions` (
  ...
  `source_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `event_instance_id` bigint unsigned NOT NULL,
  `attribution_method` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `confidence` decimal(5,2) DEFAULT NULL,
  `meta` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `marketing_paid_media_daily_stats` (
  ...
  `account_id` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metric_date` date NOT NULL,
  `campaign_id` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `campaign_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ad_set_id` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ad_set_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ad_id` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `utm_content` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `utm_term` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `row_fingerprint` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `raw_payload` json DEFAULT NULL,
  `last_synced_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `marketing_profile_links` (
  ...
  `match_method` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `confidence` decimal(5,2) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `marketing_profile_scent_quiz_results` (
  ...
  `marketing_profile_id` bigint unsigned NOT NULL,
  `tenant_id` bigint unsigned NOT NULL,
  `quiz_version` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'scent-v1',
  `axis_scores` json NOT NULL,
  `dominant_traits` json DEFAULT NULL,
  `headline` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `personality_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `personality_body` text COLLATE utf8mb4_unicode_ci,
  `public_share_token` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_profile_scores` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `marketing_profile_id` bigint unsigned NOT NULL,
  `score_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `score` int NOT NULL,
...
CREATE TABLE `marketing_profile_wishlist_items` (
  ...
  `provider` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'backstage',
  `integration` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'native',
  `store_key` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_id` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_variant_id` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_handle` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `source` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_surface` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_ref` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_profiles` (
  ...
  `first_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_first_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_last_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `first_name_phonetic` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_name_phonetic` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `mobile_avatar_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_review_histories` (
  ...
  `store_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_customer_id` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `external_review_id` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rating` tinyint unsigned DEFAULT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `body` text COLLATE utf8mb4_unicode_ci,
  `reviewer_name` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reviewer_email` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_published` tinyint(1) DEFAULT NULL,
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'approved',
  `submission_source` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `product_id` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_id` bigint unsigned DEFAULT NULL,
  `order_line_id` bigint unsigned DEFAULT NULL,
  `product_handle` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `variant_id` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reviewed_at` timestamp NULL DEFAULT NULL,
  `submitted_at` timestamp NULL DEFAULT NULL,
  ...
  `reward_eligibility_status` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reward_award_status` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reward_amount_cents` int DEFAULT NULL,
  `reward_rule_key` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `candle_cash_task_event_id` bigint unsigned DEFAULT NULL,
  `candle_cash_task_completion_id` bigint unsigned DEFAULT NULL,
  `source_synced_at` timestamp NULL DEFAULT NULL,
  `raw_payload` json DEFAULT NULL,
...
CREATE TABLE `marketing_review_summaries` (
  ...
  `store_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_customer_id` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `external_customer_email` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_segments` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `channel_scope` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_social_share_claims` (
  ...
  `target_id` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `share_url` varchar(2048) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'started',
  `proof_url` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proof_text` text COLLATE utf8mb4_unicode_ci,
  `candle_cash_transaction_id` bigint unsigned DEFAULT NULL,
  `started_at` timestamp NULL DEFAULT NULL,
  `claimed_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `marketing_storefront_events` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `event_type` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ok',
  `issue_type` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_surface` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `endpoint` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `request_key` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signature_mode` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `marketing_profile_id` bigint unsigned DEFAULT NULL,
  `tenant_id` bigint unsigned DEFAULT NULL,
  `event_instance_id` bigint unsigned DEFAULT NULL,
  `candle_cash_redemption_id` bigint unsigned DEFAULT NULL,
  `source_type` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_id` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta` json DEFAULT NULL,
  `occurred_at` timestamp NULL DEFAULT NULL,
  `resolution_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
...
CREATE TABLE `marketing_template_definitions` (
  ...
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail_svg` text COLLATE utf8mb4_unicode_ci,
  `default_subject` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `marketing_template_instances` (
  ...
  `advanced_html` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `marketing_timing_insights` (
  ...
  `objective` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `segment_key` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `event_context` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recommended_hour` tinyint unsigned DEFAULT NULL,
  `recommended_daypart` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `confidence` decimal(5,2) DEFAULT NULL,
  `reasons_json` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `marketing_wishlist_outreach_queue` (
  ...
  `product_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `channel` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sms',
  `queue_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'queued',
  `offer_type` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `offer_value` decimal(10,2) DEFAULT NULL,
  `offer_code` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_message_id` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message_body` text COLLATE utf8mb4_unicode_ci,
  `delivery_error` text COLLATE utf8mb4_unicode_ci,
  `created_by` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `markets` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `default_location_city` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_location_state` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `messaging_contact_channel_states` (
  ...
  `email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sms_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unknown',
  `email_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unknown',
  `sms_status_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_status_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sms_status_changed_at` timestamp NULL DEFAULT NULL,
  `email_status_changed_at` timestamp NULL DEFAULT NULL,
  `provider_source` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `messaging_conversation_messages` (
  ...
  `provider` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unknown',
  `provider_message_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dedupe_hash` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `body` longtext COLLATE utf8mb4_unicode_ci,
  `normalized_body` longtext COLLATE utf8mb4_unicode_ci,
  `subject` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `sent_at` timestamp NULL DEFAULT NULL,
  `delivery_status` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `message_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
...
CREATE TABLE `mobile_authorization_codes` (
  ...
  `client_id` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'everbranch-mobile',
  `device_name` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `mobile_push_devices` (
  ...
  `authorization_status` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `push_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `app_version` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `app_build` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `locale` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_seen_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `operator_alert_logs` (
  ...
  `dedupe_key` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tenant_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `operator_recurring_costs` (
  ...
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD',
  `cadence` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'monthly',
  `effective_on` date DEFAULT NULL,
  `source` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
  `receipt_reference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `active` tinyint(1) NOT NULL DEFAULT '1',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `order_line_scent_splits` (
  ...
  `allocation_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual_split',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_by` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `order_lines` (
  ...
  `scent_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `wick_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pour_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `started_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `shopify_store` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_store_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_order_id` bigint unsigned DEFAULT NULL,
  `shopify_customer_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_code` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `storefront_checkout_token` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `storefront_cart_token` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `storefront_session_key` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `storefront_client_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `storefront_link_method` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pour_batches` (
  ...
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `selection_mode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pouring_measurements` (
  ...
  `product_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'candle',
  `wax_grams` decimal(10,2) NOT NULL DEFAULT '0.00',
  `oil_grams` decimal(10,2) NOT NULL DEFAULT '0.00',
  `total_grams` decimal(10,2) NOT NULL DEFAULT '0.00',
  `active` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE `quickbooks_reporting_settings` (
  ...
  `sync_cadence` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'hourly',
  `supplies_account_mappings` longtext COLLATE utf8mb4_unicode_ci,
  `wage_account_mappings` longtext COLLATE utf8mb4_unicode_ci,
  `contract_labor_account_mappings` longtext COLLATE utf8mb4_unicode_ci,
  `owner_compensation_account_mappings` longtext COLLATE utf8mb4_unicode_ci,
  `owner_compensation_adjustments` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `quickbooks_reporting_snapshots` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `integration_connection_id` bigint unsigned NOT NULL,
  `range_key` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `period_start` date NOT NULL,
  `period_end` date NOT NULL,
  `metrics` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `quickbooks_sync_runs` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `integration_connection_id` bigint unsigned NOT NULL,
  `mode` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'incremental',
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'running',
...
CREATE TABLE `retail_plan_items` (
  ...
  `source` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'order',
  `source_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `box_tier` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `retail_plans` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `queue_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'retail',
  `event_id` bigint unsigned DEFAULT NULL,
  `created_by` bigint unsigned DEFAULT NULL,
  `published_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `scent_aliases` (
  ...
  `scent_id` bigint unsigned NOT NULL,
  `scope` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'markets',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `scent_recipes` (
  ...
  `activated_at` timestamp NULL DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `source_context` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `scents` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `display_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `oil_reference_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `abbreviation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `lifecycle_status` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `service_inquiries` (
  ...
  `business_size` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `current_tools` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `timeline` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `budget_range` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pain_point` text COLLATE utf8mb4_unicode_ci,
  `calculator_payload` json DEFAULT NULL,
  `source_page` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'new',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `shopify_privacy_webhook_events` (
  ...
  `shop_domain` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `webhook_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payload_hash` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `payload_summary` json DEFAULT NULL,
  `status` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual_review_required',
...
CREATE TABLE `shopify_product_option_assignments` (
  ...
  `shopify_product_id` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_handle` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `shopify_product_option_rulesets` (
  ...
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
  `source` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'everbranch',
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `shopify_stores` (
  ...
  `tenant_id` bigint unsigned DEFAULT NULL,
  `store_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `store_role` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'retail',
...
CREATE TABLE `square_customers` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `square_customer_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `square_orders` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `square_order_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `square_customer_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_money_amount` bigint DEFAULT NULL,
  `total_money_currency` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `closed_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `subscription_authorizations` (
  ...
  `billing_lane` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provider` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `purchase_key` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'authorized',
  `pricing_model` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'agreement_specific',
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD',
  `billing_interval` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'month',
  ...
  `tax_treatment` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'provider_calculated_if_applicable',
  `tax_disclosure` text COLLATE utf8mb4_unicode_ci,
  `authorized_line_items` json DEFAULT NULL,
  `provider_subscription_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_plan_handle` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `subscription_billing_attempts` (
  ...
  `shopify_subscription_contract_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_billing_attempt_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_order_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `idempotency_key` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `error_message` text COLLATE utf8mb4_unicode_ci,
  `next_action_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `subscription_candle_club_monthly_scents` (
  ...
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'chosen',
  `shopify_product_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_product_handle` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_product_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `shopify_collection_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `photo_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `photo_source` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `photo_author` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `photo_query` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `subscription_candle_club_scent_feedback` (
  ...
  `body` text COLLATE utf8mb4_unicode_ci,
  `visibility` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'candle_club',
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `subscription_candle_club_settings` (
  ...
  `first_gift_product_variant_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `first_gift_label` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Free 8oz Coffeehouse candle',
  `renewal_gift_product_variant_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `renewal_gift_label` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Free renewal candle',
  `cancellation_prompt` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `subscription_contract_lines` (
  ...
  `shopify_subscription_line_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_product_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_product_variant_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_selling_plan_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `subscription_contracts` (
  ...
  `marketing_profile_id` bigint unsigned DEFAULT NULL,
  `shopify_subscription_contract_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recharge_subscription_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_customer_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_payment_method_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `is_candle_club` tinyint(1) NOT NULL DEFAULT '0',
  `next_billing_date` date DEFAULT NULL,
  `next_shipping_date` date DEFAULT NULL,
  `billing_interval_count` int unsigned NOT NULL DEFAULT '1',
  `billing_interval` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'month',
  `delivery_interval_count` int unsigned NOT NULL DEFAULT '1',
  `delivery_interval` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'month',
...
CREATE TABLE `subscription_customers` (
  ...
  `marketing_profile_id` bigint unsigned DEFAULT NULL,
  `shopify_customer_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recharge_customer_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_email` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_phone` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `billing_address` json DEFAULT NULL,
  `shipping_address` json DEFAULT NULL,
  `metadata` json DEFAULT NULL,
...
CREATE TABLE `subscription_lifecycle_events` (
  ...
  `actor_user_id` bigint unsigned DEFAULT NULL,
  `event_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'evergrove',
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'recorded',
...
CREATE TABLE `subscription_migration_batches` (
  ...
  `created_by_user_id` bigint unsigned DEFAULT NULL,
  `approved_by_user_id` bigint unsigned DEFAULT NULL,
  `source` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'recharge_api',
  `mode` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'dry_run',
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `subscription_migration_rows` (
  ...
  `source_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'subscription',
  `source_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `shopify_customer_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_subscription_contract_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recharge_customer_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `subscription_module_settings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `module_key` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'subscriptions',
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'setup',
...
CREATE TABLE `subscription_payment_methods` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `subscription_customer_id` bigint unsigned DEFAULT NULL,
  `shopify_payment_method_gid` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `shopify_customer_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `brand` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_digits` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `expiry_month` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `expiry_year` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `subscription_polls` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `poll_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'candle_club_scent',
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `opens_at` timestamp NULL DEFAULT NULL,
  `closes_at` timestamp NULL DEFAULT NULL,
  `share_token` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `subscription_voter_verification_tokens` (
  ...
  `identifier_hash` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code_hash` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `delivery_channel` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `expires_at` timestamp NOT NULL,
...
CREATE TABLE `subscription_votes` (
  ...
  `subscription_contract_id` bigint unsigned DEFAULT NULL,
  `marketing_profile_id` bigint unsigned DEFAULT NULL,
  `shopify_subscription_contract_gid` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `shopify_customer_gid` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_email` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `normalized_phone` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'storefront',
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `team_channels` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `direct_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `archived_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tenant_access_addons` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `addon_key` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
  `source` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
...
CREATE TABLE `tenant_access_profiles` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `plan_key` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'shopify_proof_of_concept',
  `operating_mode` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'shopify',
  `source` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `tenant_billing_fulfillments` (
  ...
  `provider_customer_reference` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_subscription_reference` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_checkout_session_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state_hash` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `desired_plan_key` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `desired_addon_keys` json DEFAULT NULL,
  `desired_operating_mode` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'attempted',
  `message` text COLLATE utf8mb4_unicode_ci,
  `source_event_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_event_type` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `triggered_by` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'webhook',
  `actor_user_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `tenant_billing_orders` (
  ...
  `order_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'authorized',
  `provider` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'stripe',
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD',
  ...
  `provider_checkout_session_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_customer_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_payment_intent_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_invoice_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_subscription_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_schedule_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_provider_event_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_provider_event_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `authorized_at` timestamp NOT NULL,
...
CREATE TABLE `tenant_billing_receipts` (
  ...
  `subscription_authorization_id` bigint unsigned DEFAULT NULL,
  `provider` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provider_receipt_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provider_subscription_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `paid_at` timestamp NULL DEFAULT NULL,
  `hosted_invoice_url` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `tenant_billing_refunds` (
  ...
  `amount_cents` bigint unsigned NOT NULL,
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD',
  `reason` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'requested_by_customer',
  `note` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `tenant_billing_subscriptions` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `provider` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provider_customer_reference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_subscription_reference` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `purchase_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `started_at` timestamp NULL DEFAULT NULL,
  `current_period_ends_at` timestamp NULL DEFAULT NULL,
  `canceled_at` timestamp NULL DEFAULT NULL,
  `ended_at` timestamp NULL DEFAULT NULL,
  `last_event_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_event_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tenant_brand_assets` (
  ...
  `source` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'bundled',
  `storage_disk` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `path` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tenant_brand_profiles` (
  ...
  `light_logo_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dark_logo_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icon_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `asset_sources` json DEFAULT NULL,
  `primary_color` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#123C43',
  `accent_color` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#1E5A63',
  `surface_color` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#FFFFFF',
  `text_color` varchar(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#0F1C1F',
  `display_style` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'classic',
  `corner_style` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'soft',
  `decor_preset` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
  `theme_key` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'custom',
  `metadata` json DEFAULT NULL,
  `created_by_user_id` bigint unsigned DEFAULT NULL,
  `updated_by_user_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `tenant_direct_invoices` (
  ...
  `authorization_reference` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `provider_invoice_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_payment_intent_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_invoice_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hosted_invoice_url` text COLLATE utf8mb4_unicode_ci,
  `invoice_pdf_url` text COLLATE utf8mb4_unicode_ci,
  `last_provider_event_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_provider_event_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tenant_discovery_pages` (
  ...
  `page_type` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `meta_description` text COLLATE utf8mb4_unicode_ci,
  `summary` text COLLATE utf8mb4_unicode_ci,
  `intent_label` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `audience_type` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recommended_domain_role` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `canonical_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tenant_discovery_profiles` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `primary_brand_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alternate_brand_names` json DEFAULT NULL,
  `wholesale_brand_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `retail_brand_label` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `short_brand_summary` text COLLATE utf8mb4_unicode_ci,
  `long_form_description` text COLLATE utf8mb4_unicode_ci,
  ...
  `primary_logo_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tenant_email_settings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `email_provider` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sendgrid',
  `email_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `from_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `from_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reply_to_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_configured',
  `provider_status_checked_at` timestamp NULL DEFAULT NULL,
  `provider_status_message` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `tenant_employee_invitations` (
  ...
  `status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `delivery_status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_sent',
  `provider_message_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_error` text COLLATE utf8mb4_unicode_ci,
  `expires_at` timestamp NOT NULL,
  `accepted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `tenant_forms` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `channel` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'backstage',
  `schema` json DEFAULT NULL,
...
CREATE TABLE `tenant_member_preferences` (
  ...
  `job_comment_notifications` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'participating',
...
CREATE TABLE `tenant_messaging_accounts` (
  ...
  `channel` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provider` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mode` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform_managed',
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_configured',
  ...
  `sender_identifier` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `authenticated_domain` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tenant_messaging_ledger_entries` (
  ...
  `status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'settled',
  `channel` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `provider_cost_micros` bigint unsigned NOT NULL DEFAULT '0',
  `pricing_version` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tenant_messaging_sender_profiles` (
  ...
  `reply_to_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `authenticated_domain` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reply_mode` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'everbranch_inbox',
...
CREATE TABLE `tenant_module_entitlements` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `module_key` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `availability_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'available',
  `enabled_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inherit',
  `billing_status` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price_override_cents` int DEFAULT NULL,
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD',
  `entitlement_source` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price_source` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `starts_at` timestamp NULL DEFAULT NULL,
  `ends_at` timestamp NULL DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `metadata` json DEFAULT NULL,
...
CREATE TABLE `tenant_module_states` (
  ...
  `setup_status` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_started',
...
CREATE TABLE `tenant_onboarding_blueprint_provisionings` (
  ...
  `first_open_payload_anchor` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `first_open_opened_path` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tenant_onboarding_blueprints` (
  ...
  `created_by_user_id` bigint unsigned DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  `account_mode` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'production',
  `rail` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'direct',
...
CREATE TABLE `tenant_payment_accounts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `provider` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'stripe_connect',
  `provider_account_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_started',
...
CREATE TABLE `tenant_plant_inventory_adjustments` (
  ...
  `adjustment_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tenant_plant_inventory_items` (
  ...
  `sku` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vendor_source` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `purchased_cost` decimal(10,2) DEFAULT NULL,
  `sell_price` decimal(10,2) DEFAULT NULL,
  `quantity_on_hand` int NOT NULL DEFAULT '0',
  `reserved_quantity` int NOT NULL DEFAULT '0',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `square_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_product_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shopify_variant_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tenant_setup_statuses` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `business_profile_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_started',
  `import_path` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'undecided',
  `shopify_connection_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_connected',
  `square_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_requested',
  `csv_manual_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_started',
  `module_interests` json DEFAULT NULL,
  `mobile_interest` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'undecided',
  `plan_interest` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'undecided',
  `billing_lane_interest` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'undecided',
  `implementation_help_interest` tinyint(1) NOT NULL DEFAULT '0',
  `commercial_notes` text COLLATE utf8mb4_unicode_ci,
  `commercial_review_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending_review',
  `commercial_next_action` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `commercial_reviewed_by` bigint unsigned DEFAULT NULL,
  `commercial_reviewed_at` timestamp NULL DEFAULT NULL,
  `landlord_review_status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending_review',
  `next_recommended_action` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `internal_notes` text COLLATE utf8mb4_unicode_ci,
  `reviewed_by` bigint unsigned DEFAULT NULL,
  `reviewed_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `tenant_site_domains` (
  ...
  `verification_token` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tenant_site_media` (
  ...
  `tenant_site_id` bigint unsigned NOT NULL,
  `uploaded_by_user_id` bigint unsigned DEFAULT NULL,
  `storage_disk` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'local',
  `storage_path` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mime_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_size` bigint unsigned NOT NULL,
  `checksum` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kind` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'image',
  `source` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'upload',
...
CREATE TABLE `tenant_site_pages` (
  ...
  `page_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'landing',
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tenant_site_setups` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `tenant_site_id` bigint unsigned NOT NULL,
  `business_mode` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'trades',
  `offering_mode` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'services',
  `visitor_actions` json DEFAULT NULL,
  `design_key` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'collins-electric',
  `domain_choice` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'everbranch_subdomain',
  ...
  `hours` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_area` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `tenant_sites` (
  ...
  `subdomain` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `settings` json DEFAULT NULL,
...
CREATE TABLE `tenant_support_ticket_messages` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned DEFAULT NULL,
  `author_context` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `body` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tenant_support_tickets` (
  ...
  `category` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'help',
  `priority` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
  `resolution_summary` text COLLATE utf8mb4_unicode_ci,
  `source_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'account_help',
  `dedupe_key` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_activity_at` timestamp NULL DEFAULT NULL,
  `resolved_at` timestamp NULL DEFAULT NULL,
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `tenant_usage_counters` (
  ...
  `source` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'computed',
...
CREATE TABLE `tenant_wholesale_settings` (
  ...
  `qualification_mode` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'dedicated_store',
...
CREATE TABLE `users` (
  ...
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `requested_via` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `vision_ideas` (
  ...
  `impact` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'medium',
  `effort` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'medium',
  `category` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform',
  `source` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `website_customer_addresses` (
  ...
  `label` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Primary',
  `name` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `line1` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `website_fulfillments` (
  ...
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unfulfilled',
...
CREATE TABLE `website_order_events` (
  ...
  `user_id` bigint unsigned DEFAULT NULL,
  `event_type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `visibility` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'staff',
  `message` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `website_order_lines` (
  ...
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity` int unsigned NOT NULL,
...
CREATE TABLE `website_orders` (
  ...
  `lookup_token` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'usd',
  `order_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
  `source` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'native',
  `risk_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
  `review_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
  `exception_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
  `payment_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `fulfillment_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unfulfilled',
  `fulfillment_method` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `website_payments` (
  ...
  `provider_session_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `website_product_variants` (
  ...
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Default',
  `sku` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `website_products` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `tenant_site_id` bigint unsigned NOT NULL,
  `handle` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_type` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'physical',
  `description` text COLLATE utf8mb4_unicode_ci,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
...
CREATE TABLE `website_shipments` (
  ...
  `provider` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'easypost',
  `provider_shipment_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `provider_rate_id` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `carrier` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tracking_number` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tracking_url` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `label_url` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `website_shipping_rate_quotes` (
  ...
  `provider` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'easypost',
  `provider_shipment_id` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provider_rate_id` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `carrier` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `website_stripe_webhook_events` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned DEFAULT NULL,
  `stripe_event_id` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `event_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'received',
...
CREATE TABLE `wholesale_accounts` (
  ...
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'confirmed',
  `source_prospect_public_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `existing_customer_key` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `original_discovery_source` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `wholesale_custom_scents` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `account_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `custom_scent_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `oil_1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `oil_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `oil_3` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `wholesale_follow_ups` (
  ...
  `follow_up_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sales_review',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open',
...
CREATE TABLE `wholesale_order_classifications` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `order_id` bigint unsigned NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending_review',
  `classification_basis` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `wholesale_prospect_discovery_runs` (
  ...
  `public_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'queued',
  `search_region` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `campaign_name` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estimated_api_cost` decimal(10,4) NOT NULL DEFAULT '0.0000',
  `actual_api_cost` decimal(10,4) NOT NULL DEFAULT '0.0000',
...
CREATE TABLE `wholesale_prospect_evidence` (
  ...
  `source_type` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_url` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signal_type` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `summary` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `wholesale_prospects` (
  ...
  `tenant_id` bigint unsigned NOT NULL,
  `public_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `business_name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'newly_discovered',
  `primary_category` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `phone` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `website` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `public_business_email` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_form_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `instagram_handle` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `facebook_page` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_place_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_maps_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `operational_status` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `discovery_source` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `discovery_query` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `opportunity_priority` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
  `suggested_product_positioning` text COLLATE utf8mb4_unicode_ci,
  `suggested_opening_message_topic` text COLLATE utf8mb4_unicode_ci,
  `last_reviewed_at` timestamp NULL DEFAULT NULL,
  ...
  `duplicate_status` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `existing_customer_match` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `wholesale_suggestion_decisions` (
  ...
  `note` text COLLATE utf8mb4_unicode_ci,
  `dismissal_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `wholesale_suggestions` (
  ...
  `target_type` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `suggestion_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `reason` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `evidence_fingerprint` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `snoozed_until` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `workspace_asset_uploads` (
  ...
  `field_service_job_id` bigint unsigned DEFAULT NULL,
  `token_hash` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `storage_disk` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `storage_path` varchar(1024) COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mime_type` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `max_file_size` bigint unsigned NOT NULL,
  `visibility` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'team',
  `caption` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'initialized',
  `expires_at` timestamp NOT NULL,
  `completed_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `workspace_assets` (
  ...
  `storage_disk` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'local',
  `storage_path` varchar(1024) COLLATE utf8mb4_unicode_ci NOT NULL,
  `thumbnail_disk` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `caption` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tags` json DEFAULT NULL,
  `search_text` longtext COLLATE utf8mb4_unicode_ci,
  `metadata` json DEFAULT NULL,
  `captured_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
