...
function Editor({ root }: { root: HTMLElement }) {
  ...
  const commit = (next: Page) => { hasUnsavedChanges.current = true; setHistory((items) => [...items.slice(-29), page]); setFuture([]); setPage(next); setSaving("Unsaved changes"); };
