...
function routeDocumentToAction(document, helpers) {
  ...
  return {
    ...
    entityLabels: Array.isArray(document.entityLabels) ? document.entityLabels : [normalizeLabel(section), "page"],
...
export function registerDefaultShopifyActions(context = {}, provider) {
  ...
  const actions = [
    ...
    },
    {
      ...
      synonyms: ["checkouts"],
      breadcrumbs: ["Shopify tools"],
      entityLabels: ["checkouts"],
      intentPhrases: ["view", "open"],
      source: "explicit",
      entityType: "shopify-admin",
    ...
    },
    {
      ...
      entityLabels: ["shipping", "settings"],
    ...
    },
    {
      ...
      entityLabels: ["section"],
      intentPhrases: ["open", "view"],
      source: "explicit",
