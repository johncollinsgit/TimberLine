<x-app-layout>
    <x-slot name="header">
        <h1 class="text-xl font-semibold text-zinc-900">Landlord Messages</h1>
    </x-slot>
        ...
        <section class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div>
                    ...
                    <h2 class="mt-2 text-3xl font-semibold text-zinc-950">Messages &amp; Inquiries</h2>
                    <p class="mt-2 max-w-3xl text-sm text-zinc-600">
                        Messages from Evergrove and Everbranch contact forms, service pages, and calculators, including any attached planning payload.
                    </p>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[1120px] divide-y divide-zinc-200 text-sm">
                    ...
                    <tbody class="divide-y divide-zinc-200 bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-10 text-center text-sm text-zinc-500">No messages yet.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
