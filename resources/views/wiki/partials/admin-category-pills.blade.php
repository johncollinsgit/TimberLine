...
@if($isAdmin && !empty($category['slug'] ?? null))
    <div class="flex items-center gap-2">
        <a href="{{ route('wiki.admin.category.edit', ['slug' => $category['slug']]) }}" class="rounded-full border border-sky-300/40 bg-sky-100 px-3 py-1 text-xs font-medium text-sky-900 hover:bg-sky-100">Edit</a>
