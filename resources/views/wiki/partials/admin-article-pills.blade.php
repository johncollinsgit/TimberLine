...
@if($isAdmin && !empty($article['slug'] ?? null))
    <div class="flex items-center gap-2">
        <a href="{{ route('wiki.admin.article.edit', ['slug' => $article['slug']]) }}" class="rounded-full border border-sky-300/40 bg-sky-500/15 px-3 py-1 text-xs font-medium text-sky-100 hover:bg-sky-500/25">Edit</a>
