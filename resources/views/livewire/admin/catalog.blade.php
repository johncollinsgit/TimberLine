<div class="space-y-6">
 ...
 <div>
 <div class="text-lg font-semibold text-zinc-900">Catalog Options</div>
 <div class="text-sm text-zinc-600">Manage locked Scent + Size dropdown lists.</div>
 </div>

 <div class="flex gap-2">
 <button type="button" wire:click="$set('tab','scents')"
 class="px-3 py-1.5 rounded-lg text-sm border
 {{ $tab === 'scents' ? 'border-emerald-400/40 bg-emerald-100 text-emerald-700' : 'border-zinc-200 text-zinc-600' }}">
 Scents
 </button>
 <button type="button" wire:click="$set('tab','sizes')"
 class="px-3 py-1.5 rounded-lg text-sm border
 {{ $tab === 'sizes' ? 'border-emerald-400/40 bg-emerald-100 text-emerald-700' : 'border-zinc-200 text-zinc-600' }}">
 Sizes
 </button>
 </div>
 </div>
 ...
 <div class="flex-1">
 <label class="block text-xs text-zinc-600 mb-1">New scent</label>
 <input type="text" wire:model.defer="newScentName"
 class="w-full rounded-lg border border-zinc-200 bg-white/70 px-3 py-2 text-sm"
 ...
 class="px-3 py-2 rounded-lg text-sm border border-emerald-400/40 bg-emerald-100 hover:bg-emerald-100">
 + Add
 </button>
 </div>
 ...
 class="px-3 py-2 rounded-lg text-xs border border-zinc-200 hover:bg-zinc-50">
 Save
 </button>
 </td>
 </tr>
 ...
 <div>
 <label class="block text-xs text-zinc-600 mb-1">New size code</label>
 ...
 <div>
 <label class="block text-xs text-zinc-600 mb-1">Label (optional)</label>
