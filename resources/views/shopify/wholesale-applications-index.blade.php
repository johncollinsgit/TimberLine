            ...
            <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-zinc-600">
                        Open new wholesale applications, review captured details, and approve buyers without leaving Shopify Admin.
                    </p>
                </div>
                            ...
                            @foreach ($applications as $application)
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 align-top text-right">
                                        <a href="{{ $embeddedUrl(route('shopify.app.wholesale.applications.show', ['accessRequest' => $application, 'store_key' => 'wholesale'], false)) }}" class="rounded-full border border-zinc-300 px-3 py-1.5 text-xs font-semibold text-zinc-700 hover:bg-zinc-100">
                                            Review
                                        </a>
                                    </td>
                                </tr>
