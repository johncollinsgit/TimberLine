...
<section class="customers-index-table" aria-label="Customers table">
    <div class="customers-index-scroll">
        <table>
            <thead>
                <tr>
                    <th>
            ...
            <tbody>
                @forelse($customers as $row)
                    ...
                    >
                        <td class="customers-identity-cell">
                            <a class="customers-identity-name" href="{{ $detailUrl }}" data-customer-prefetch-endpoint="{{ $detailSectionsUrl }}" data-customer-prefetch-profile-id="{{ (int) $row['id'] }}">{{ $row['name'] }}</a>
                            <p class="customers-identity-meta">{{ $row['email'] }}</p>
                            <p class="customers-identity-meta">{{ $row['phone'] }}</p>
                        </td>
                        ...
                        <td>
                            <span class="customers-status-badge customers-status-badge--{{ $status['key'] }}">{{ $status['label'] }}</span>
                        </td>
                        <td>
                            <a href="{{ $detailUrl }}" class="customers-row-action" data-customer-prefetch-endpoint="{{ $detailSectionsUrl }}" data-customer-prefetch-profile-id="{{ (int) $row['id'] }}">View record</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" class="customers-index-empty">
