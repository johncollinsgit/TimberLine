<x-layouts::app :title="'Marketing Recommendations'">
    <div class="mx-auto w-full max-w-[1850px] px-3 py-4 sm:px-4 sm:py-6 md:px-6 space-y-6 min-w-0">
        <x-marketing.partials.section-shell
            ...
            hint-text="Recommendations are suggestions, not autonomous sends. Every approval/rejection is recorded for auditability."
        />

        <section class="rounded-3xl border border-white/10 bg-black/15 p-5 sm:p-6 space-y-4">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <h2 class="text-lg font-semibold text-white">Recommendation Center</h2>
