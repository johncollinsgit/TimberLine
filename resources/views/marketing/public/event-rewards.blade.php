...
<main class="mx-auto max-w-3xl px-4 py-8 space-y-5">
    <section class="rounded-3xl border border-zinc-200 bg-zinc-50 p-5">
        <div class="text-xs uppercase tracking-[0.22em] text-zinc-500">TimberLine Event {{ $rewardsLabel }}</div>
        <h1 class="mt-2 text-2xl font-semibold text-zinc-950">Event {{ $rewardsLabel }} Lookup</h1>
        ...
        <section class="grid gap-4 lg:grid-cols-2">
            ...
            <article class="rounded-3xl border border-zinc-200 bg-zinc-50 p-5">
                ...
                <div class="mt-2 space-y-2">
                    ...
                    @empty
                        <div class="text-sm text-zinc-500">No active {{ strtolower($rewardsLabel) }} right now.</div>
                    @endforelse
                </div>
            </article>
        </section>
