...
<body class="fb-public-body">
    <main class="fb-public-shell fb-contact-shell">
        ...
        <section class="fb-card fb-contact-overview" aria-label="Contact overview">
        ...
        <section class="fb-section fb-contact-grid-section" aria-label="Contact channels">
            <div class="fb-grid fb-grid-2">
                @foreach((array) ($content['channels'] ?? []) as $channel)
                    <article class="fb-card fb-contact-item">
