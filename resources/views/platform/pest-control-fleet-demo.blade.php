    ...
    <main class="gs-demo__wrap">
        ...
        <section class="gs-demo__hero">
            ...
            <div class="gs-demo__grid">
                ...
                <aside class="gs-demo__access"><p class="gs-demo__eyebrow">Demo workspace access</p><h2>Try the fictional workspace</h2><div class="gs-demo__credential"><small>Login</small><code>{{ $demoEmail }}</code></div><div class="gs-demo__credential"><small>Password</small><code>{{ $demoPassword }}</code></div><a class="gs-demo__login" href="{{ route('login') }}">Log in to the demo</a><p class="gs-demo__note">This account is isolated to Green Shield Pest Control and is for demonstration only. Never enter real customer, employee, vehicle, or location data.</p></aside>
            </div>
        </section>
