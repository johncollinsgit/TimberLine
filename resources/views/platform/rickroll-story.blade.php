...
<body class="eb-story-unlisted" data-rickroll-story>
    <main>
        ...
        <div class="eb-story-unlisted__player" data-rickroll-player>
            <video data-rickroll-intro controls playsinline preload="metadata" poster="{{ asset('media/everbranch-story-poster.jpg') }}">
            ...
            <div class="eb-story-unlisted__gate" data-rickroll-gate>
                <button class="eb-story-unlisted__start" type="button" data-rickroll-start>Start the story with sound</button>
            </div>
            <div class="eb-story-unlisted__handoff" data-rickroll-handoff hidden aria-live="polite">
                <iframe title="Rick Astley — Never Gonna Give You Up" data-rickroll-src="https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ?autoplay=1&amp;mute=0&amp;playsinline=1&amp;enablejsapi=1&amp;rel=0" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>
