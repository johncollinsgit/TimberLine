...
@php
    ...
    $mfOgImage = asset('brand/forestry-backstage-lockup.svg').'?v=fb2';
@endphp
...
<link rel="icon" href="{{ asset('brand/forestry-backstage-favicon.svg') }}?v=fb2" type="image/svg+xml">
<link rel="shortcut icon" href="{{ asset('brand/forestry-backstage-favicon.svg') }}?v=fb2">
<link rel="apple-touch-icon" href="{{ asset('brand/forestry-backstage-mark.svg') }}?v=fb2">
