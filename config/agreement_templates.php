...
return [
    'front_yard_foods_launch_partner' => [
        ...
        'implementation_phases' => [
            ['phase' => '1', 'title' => 'Discovery, access, and launch plan', 'deliverables' => ['Confirm the accepted page, product, collection, policy, domain, pickup, delivery, class, consultation, and inventory scope.', 'Collect approved Shopify, Squarespace, Square, domain, content, photograph, product, pricing, tax, shipping, and policy access or files.', 'Record the implementation amount, payment schedule, client decision-maker, dependencies, exclusions, and launch acceptance checklist.']],
        ...
        'ownership' => [
            'client' => 'Front Yard Foods retains its business name, branding, Shopify store, Square account, domain, original content and photographs, products, Academy and Substack content, and client-owned customer/order data subject to law and provider terms.',
