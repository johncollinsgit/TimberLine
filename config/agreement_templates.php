...
return [
    'front_yard_foods_launch_partner' => [
        ...
        'scope_matrix' => [
            ...
            ['thing' => 'Included messaging and overages', 'surface' => 'Everbranch messaging and billing', 'approach' => 'Each calendar month includes 250 outbound SMS segments and 1,000 outbound emails. Additional usage is metered at the accepted agreement rates and invoiced after the month closes.'],
        ...
        'scope_sections' => [
            ...
            ['title' => 'Messaging allowance and usage billing', 'body' => 'The service includes 250 outbound SMS segments and 1,000 outbound emails in each calendar month. Unused allowance does not roll over. SMS above the allowance is billed at $0.05 per segment, including additional segments in long messages, and email above the allowance is billed at $0.005 per email. Everbranch records immutable usage entries and issues the overage invoice after the applicable month closes. Live messaging remains subject to provider, consent, opt-out, and delivery readiness.'],
    ...
    'collins_electric_launch_partner' => [
        ...
        'scope_sections' => [
            ...
            ['title' => 'Messaging allowance and usage billing', 'body' => 'The service includes 250 outbound SMS segments and 1,000 outbound emails in each calendar month. Unused allowance does not roll over. SMS above the allowance is billed at $0.05 per segment, including additional segments in long messages, and email above the allowance is billed at $0.005 per email. Everbranch records immutable usage entries and issues the overage invoice after the applicable month closes.'],
        ...
        'third_party_costs' => ['Stripe processing and applicable taxes', 'QuickBooks subscription and future integration costs', 'SMS carrier registration and special compliance fees not included in the stated usage allowance'],
