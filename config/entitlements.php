...
foreach ((array) ($catalog['modules'] ?? []) as $moduleKey => $definition) {
    ...
    $modules[$moduleKey] = [
        ...
        'tenant_slugs' => array_values(array_map('strval', (array) ($definition['tenant_slugs'] ?? []))),
        'shopify_store_keys' => array_values(array_map('strval', (array) ($definition['shopify_store_keys'] ?? []))),
