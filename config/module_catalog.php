...
$catalog = [
    ...
    'capabilities' => [
        ...
        'product_reviews.collect' => [
            'display_name' => 'Product review collection',
            'description' => 'Collect, moderate, and display product reviews.',
            'module_key' => 'reviews',
        ],
        'service_reviews.request' => [
            'display_name' => 'Service review request',
            'description' => 'Request a Google Business review after completed service work.',
            'module_key' => 'service_reviews',
        ],
        'lead_capture.intake' => [
    ...
    'modules' => [
        ...
        'field_service' => [
            ...
            'channels' => ['backstage'],
            'classification' => 'shared-core',
            'workspace_profiles' => ['field_service_trades'],
        ...
        'plant_inventory' => [
            ...
            'mobile' => [
                ...
                'display_name' => 'Plant Inventory',
                'renderer' => 'plant_inventory',
                'entry_screen' => 'plant-inventory.index',
                'contract_version' => 1,
                'min_app_version' => null,
                'navigation' => ['group' => 'work', 'icon' => 'archive-box', 'position' => 9],
                'actions' => ['view'],
            ],
        ],
        'activity' => [
        ...
        'rewards' => [
            ...
            'shopify_embedded_surfaces' => ['retail'],
            'classification' => 'shared-core',
            'workspace_profiles' => ['retail_commerce', 'maker_production'],
            'required_capability_packs' => ['retail_commerce'],
        ...
        'reviews' => [
            ...
            'visibility' => ['public_site' => true, 'app_store' => false],
            'cta_routing' => 'none',
            'capabilities' => ['product_reviews.collect'],
        ],
        'service_reviews' => [
            'display_name' => 'Service reviews',
            'description' => 'Request and monitor Google Business reviews after completed service work.',
            'status' => 'live',
            'market_state' => 'SAFE_TO_MARKET',
            'channels' => ['backstage'],
            'classification' => 'field-service',
            'workspace_profiles' => ['field_service_trades'],
            'required_capability_packs' => ['service_reputation'],
            'included_in_plans' => ['base', 'growth', 'pro'],
            'default_enabled' => true,
            'default_setup_status' => 'configured',
            ...
            'visibility' => ['public_site' => false, 'app_store' => false, 'mobile_store' => false],
            'cta_routing' => 'none',
            'capabilities' => ['service_reviews.request'],
        ],
        'lead_capture' => [
            'display_name' => 'Lead Capture / Intake',
