...
return [
    ...
    */
    ...
    'everbranch_work_mobile' => [
        'deep_link_url' => env('EVERBRANCH_WORK_MOBILE_DEEP_LINK_URL', 'everbranch://work/login'),
        'expo_push_url' => env('EVERBRANCH_WORK_EXPO_PUSH_URL', 'https://exp.host/--/api/v2/push/send'),
    ],
