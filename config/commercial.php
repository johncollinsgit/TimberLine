    ...
    'templates' => [
        ...
        'trades' => [
            ...
            'recommended_modules' => [
                ...
                'growth' => ['customers', 'field_service', 'reporting', 'sms', 'messaging'],
                'pro' => ['customers', 'field_service', 'reporting', 'sms', 'messaging', 'ai'],
            ],
            'dashboard_layout' => ['field_service', 'customers', 'reporting'],
            'navigation_emphasis' => ['field_service', 'customers', 'reporting'],
            'onboarding_checklist' => [
                'Confirm the Trades template and the first outcome',
        ...
        'trades_electrical' => [
            ...
            'recommended_modules' => [
                'base' => ['customers', 'field_service', 'reporting'],
                'starter' => ['customers', 'field_service', 'reporting', 'messaging'],
                'growth' => ['customers', 'field_service', 'reporting', 'sms', 'messaging'],
                'pro' => ['customers', 'field_service', 'reporting', 'sms', 'messaging', 'ai'],
            ],
            'dashboard_layout' => ['field_service', 'customers', 'reporting'],
            'navigation_emphasis' => ['field_service', 'customers', 'reporting'],
            'onboarding_checklist' => [
                'Confirm the electrical preset and the first outcome',
                'Choose the safe visible modules that should be available now',
                'Review the label tweaks before the workspace opens',
            ],
        ],
        'trades_plumbing' => [
            ...
            'navigation_emphasis' => ['field_service', 'customers', 'reporting'],
            'onboarding_checklist' => [
                'Confirm the plumbing preset and the first outcome',
                'Choose the safe visible modules that should be available now',
                'Review the label tweaks before the workspace opens',
            ],
        ],
        'home_residential' => [
            ...
            'recommended_modules' => [
                'base' => ['customers', 'projects', 'tasks', 'messaging'],
                'starter' => ['customers', 'projects', 'tasks', 'messaging'],
                'growth' => ['customers', 'projects', 'tasks', 'sms', 'messaging'],
                'pro' => ['customers', 'projects', 'tasks', 'sms', 'messaging', 'ai'],
            ],
            'dashboard_layout' => ['projects', 'customers', 'reporting'],
            'navigation_emphasis' => ['projects', 'customers', 'reporting'],
            'onboarding_checklist' => [
                'Confirm the residential preset and the first outcome',
                'Choose the safe visible modules that should be available now',
                'Review the label tweaks before the workspace opens',
            ],
        ],
        'electrician' => [
            'name' => 'Electrician (Legacy Alias)',
            'position' => 19,
            'active' => true,
            'aliases' => ['trades_electrical'],
            'recommended_modules' => [
                'base' => ['customers', 'field_service', 'reporting'],
                'starter' => ['customers', 'field_service', 'reporting', 'messaging'],
                'growth' => ['customers', 'field_service', 'reporting', 'sms', 'messaging'],
