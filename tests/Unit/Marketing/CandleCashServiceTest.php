...
test('candle cash service converts historical legacy starting points with the canonical 0.3 rule', function () {
    $service = app(CandleCashService::class);

    expect($service->legacyPointsToStartingCandleCash(100))->toBe(30.0)
        ->and($service->legacyPointsToStartingCandleCash(125))->toBe(37.5)
        ->and($service->amountFromPoints(37.5))->toBe(37.5)
