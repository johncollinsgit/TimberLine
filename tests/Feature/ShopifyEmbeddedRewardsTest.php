    ...
    $sendGrid->shouldReceive('sendEmail')
        ...
        ->withArgs(function (string $toEmail, string $subject, string $body, array $options): bool {
            return $toEmail === 'finance.ops@example.com'
                ...
                && str_contains($body, 'https://app.theeverbranch.com/rewards/policy/exports/signed/'.$this->tenant->id.'/finance_summary')
                && str_contains($body, 'https://app.theeverbranch.com/rewards/policy/exports/signed/'.$this->tenant->id.'/reward_issuance')
                && str_contains($body, 'https://app.theeverbranch.com/rewards/policy/exports/signed/'.$this->tenant->id.'/reward_redemption')
                && str_contains($body, 'https://app.theeverbranch.com/rewards/policy/exports/signed/'.$this->tenant->id.'/expiring_rewards')
