    ...
    Route::middleware(['auth:sanctum', 'throttle:120,1'])->group(function (): void {
        ...
        Route::prefix('/workspaces/{tenant}')
            ...
            ->group(function (): void {
                ...
                Route::post('/field-service/jobs/{job}/photos/payload', [EverbranchMobileFieldServiceController::class, 'uploadPhotoPayload'])->middleware(['abilities:mobile:write', 'throttle:30,1'])->whereNumber('job')->name('workspace.field-service.jobs.photos.payload');
