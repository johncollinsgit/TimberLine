    ...
    Route::middleware(['auth:sanctum', 'throttle:120,1'])->group(function (): void {
        ...
        Route::prefix('/workspaces/{tenant}')
            ...
            ->group(function (): void {
                ...
                Route::get('/field-service/job-drafts', [EverbranchMobileWorkCandidateController::class, 'index'])->middleware('abilities:mobile:read')->name('workspace.field-service.job-drafts.index');
                Route::get('/field-service/job-drafts/{draft}', [EverbranchMobileWorkCandidateController::class, 'show'])->middleware('abilities:mobile:read')->whereNumber('draft')->name('workspace.field-service.job-drafts.show');
                Route::patch('/field-service/job-drafts/{draft}', [EverbranchMobileWorkCandidateController::class, 'update'])->middleware(['abilities:mobile:write', 'throttle:30,1'])->whereNumber('draft')->name('workspace.field-service.job-drafts.update');
                Route::post('/field-service/job-drafts/{draft}/publish', [EverbranchMobileWorkCandidateController::class, 'publish'])->middleware(['abilities:mobile:write', 'throttle:30,1'])->whereNumber('draft')->name('workspace.field-service.job-drafts.publish');
                Route::post('/field-service/job-drafts/{draft}/link', [EverbranchMobileWorkCandidateController::class, 'link'])->middleware(['abilities:mobile:write', 'throttle:30,1'])->whereNumber('draft')->name('workspace.field-service.job-drafts.link');
                ...
                // A single job walk-through supports up to twenty photos. Leave room for
                // a native-upload retry without rate limiting a valid field submission.
                Route::post('/field-service/jobs/{job}/photos', [EverbranchMobileFieldServiceController::class, 'uploadPhotos'])->middleware(['abilities:mobile:write', 'throttle:120,1'])->whereNumber('job')->name('workspace.field-service.jobs.photos');
                Route::post('/field-service/jobs/{job}/photos/payload', [EverbranchMobileFieldServiceController::class, 'uploadPhotoPayload'])->middleware(['abilities:mobile:write', 'throttle:120,1'])->whereNumber('job')->name('workspace.field-service.jobs.photos.payload');
                ...
                Route::post('/field-service/jobs/{job}/tasks/{task}/photos', [EverbranchMobileFieldServiceController::class, 'uploadTaskPhotos'])->middleware(['abilities:mobile:write', 'throttle:120,1'])->whereNumber('job')->whereNumber('task')->name('workspace.field-service.jobs.tasks.photos');
                Route::post('/field-service/jobs/{job}/tasks/{task}/photos/payload', [EverbranchMobileFieldServiceController::class, 'uploadTaskPhotoPayload'])->middleware(['abilities:mobile:write', 'throttle:120,1'])->whereNumber('job')->whereNumber('task')->name('workspace.field-service.jobs.tasks.photos.payload');
